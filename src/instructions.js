class Instructions {
    ...
    constructor() {
        ...
        this.closeInstructionsEl = document.getElementsByClassName('close-instructions')[0];
        this.openInstructionsEl = document.getElementsByClassName('open-instructions')[0];
